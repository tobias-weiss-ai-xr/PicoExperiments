...
namespace SoftMasking {
    ...
    public class SoftMask : UIBehaviour, ISoftMask, ICanvasRaycastFilter {
		...
		void FillCommonParameters() {
			...
			maskTransform.GetWorldCorners(corners);

			_parameters.uiToWorld = UIToWorld();
			_parameters.worldToLocal = maskTransform.worldToLocalMatrix;

			_parameters.maskPlane = Vector3.Cross(corners[1] - corners[0], corners[2] - corners[0]).normalized;
			_parameters.maskPlane.w = - Vector3.Dot(_parameters.maskPlane, corners[0]);
        ...
        Matrix4x4 UIToWorld() {
            return canvas.rootCanvas.transform.localToWorldMatrix;
        }
        ...
        class MaterialReplacerImpl : IMaterialReplacer {
            ...
            public Material Replace(Material original) {
                if (original.shader.name.Contains("FixAlpha"))
                {
                    Debug.Log("FIxalpha");
                }
        ...
        struct MaterialParameters {
            ...
            public Matrix4x4 uiToWorld;
			public Matrix4x4 worldToLocal;
            public Texture2D texture;
            public BorderMode borderMode;

			public Vector4 maskPlane;
            ...
            public void Apply(Material mat) {
				...
				mat.SetVector(Ids.SoftMask_Plane, maskPlane);

				mat.SetMatrix(Ids.SoftMask_UIToWorld, uiToWorld);
				mat.SetMatrix(Ids.SoftMask_WorldToLocal, worldToLocal);
            ...
            static class Ids {
                ...
                public static readonly int SoftMask_UIToWorld = Shader.PropertyToID("_SoftMask_UIToWorld");
                public static readonly int SoftMask_Plane = Shader.PropertyToID("_SoftMask_Plane");
				public static readonly int SoftMask_WorldToLocal = Shader.PropertyToID("_SoftMask_WorldToLocal");
